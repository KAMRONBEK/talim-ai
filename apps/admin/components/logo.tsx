 ...
 * (Logo v3): two-tone pages branching into linked nodes, the top one a clay
 * spark. Default renders the cream mark on a pine squircle tile; `mono` renders
 * just the glyph in `currentColor` (no tile).
 */

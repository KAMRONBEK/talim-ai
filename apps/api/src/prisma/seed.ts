...
const PLANS: PlanSeed[] = [
  {
    ...
    name: 'Free',
    kind: 'INDIVIDUAL',
    limits: { maxUploads: 3, maxGenerationsPerMonth: 20, maxTutorMessages: 50 },
  },
  {
    ...
    name: 'Individual Pro',
    kind: 'INDIVIDUAL',
    limits: { maxUploads: null, maxGenerationsPerMonth: 500, maxTutorMessages: null },
  },
  {
    ...
    name: 'Tenant Starter',
    kind: 'TENANT',
    limits: { maxStudents: 25, maxContentItems: 100, maxGenerationsPerMonth: 500 },
  },
  {
    ...
    name: 'Tenant Growth',
    kind: 'TENANT',
    limits: { maxStudents: 100, maxContentItems: 500, maxGenerationsPerMonth: 2000 },
  },
];

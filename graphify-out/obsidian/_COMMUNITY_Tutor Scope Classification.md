...
```dataview
TABLE source_file, type FROM #community/Tutor_Scope_Classification
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_Chat Controller (SSE)]]
...
- [[scriptVariants()]] - degree 8, connects to 2 communities

...
```dataview
TABLE source_file, type FROM #community/TTS_Synthesis
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Bull Jobs & Queues]]
...
- [[synthesizeDialogueWithSegments()]] - degree 6, connects to 1 community

...
```dataview
TABLE source_file, type FROM #community/Learning_Workspace_Docs
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Feature Catalog Docs]]
- 1 edge to [[_COMMUNITY_Deploy Pipeline Docs]]

## Top bridge nodes
- [[Multi-Tenant Isolation Guard (contentAccess.service)]] - degree 3, connects to 2 communities

...
```dataview
TABLE source_file, type FROM #community/Grading_Engine_Design_Docs
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Question Engine Design Docs]]
- 2 edges to [[_COMMUNITY_Feature Catalog Docs]]

## Top bridge nodes
- [[11-Type Question Grading Engine (packagestypesgrading.ts)]] - degree 5, connects to 2 communities
- [[Unified Grading Module (packagestypesgrading.ts)]] - degree 5, connects to 1 community
- [[Partial Credit Rules (creditFraction)]] - degree 4, connects to 1 community
- [[Uzbek Apostrophe Normalization]] - degree 3, connects to 1 community
- [[Question Banks (AI-Generated + Manual, Approve Flow)]] - degree 2, connects to 1 community
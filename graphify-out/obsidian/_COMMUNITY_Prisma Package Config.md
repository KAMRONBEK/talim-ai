...
```dataview
TABLE source_file, type FROM #community/Prisma_Package_Config
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_API Backend Dependencies]]
- 1 edge to [[_COMMUNITY_API Dev Dependencies]]
- 1 edge to [[_COMMUNITY_Build & Database Scripts]]

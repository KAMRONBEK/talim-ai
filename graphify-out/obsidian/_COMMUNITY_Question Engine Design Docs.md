...
```dataview
TABLE source_file, type FROM #community/Question_Engine_Design_Docs
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Grading Engine Design Docs]]
- 3 edges to [[_COMMUNITY_Feature Catalog Docs]]

## Top bridge nodes
- [[Practice Generator (Unified Questions + Flashcards)]] - degree 6, connects to 2 communities
...
- [[Flashcards as First-Class Question Type]] - degree 3, connects to 1 community
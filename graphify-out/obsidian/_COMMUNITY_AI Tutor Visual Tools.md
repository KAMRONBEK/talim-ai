...
```dataview
TABLE source_file, type FROM #community/AI_Tutor_Visual_Tools
SORT file.name ASC
```

## Connections to other communities
- 17 edges to [[_COMMUNITY_Shared Types & Zustand Stores]]
- 6 edges to [[_COMMUNITY_AI Tutor Chat Controller]]
- 5 edges to [[_COMMUNITY_AI Provider Service]]
- 3 edges to [[_COMMUNITY_Tutor Chat Visual Components]]
- 2 edges to [[_COMMUNITY_Slide Deck Player UI]]
...
- [[ManimPayload]] - degree 5, connects to 3 communities
- [[tutor-chart.ts]] - degree 6, connects to 2 communities
- [[tutor-html-sandbox.ts]] - degree 6, connects to 2 communities
- [[tutor-mermaid.ts]] - degree 6, connects to 2 communities
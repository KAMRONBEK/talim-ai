...
# components learning · pdf-area-selection.ts
...
```dataview
TABLE source_file, type FROM #community/components_learning__pdf-area-selectionts
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_components learning]]
- 1 edge to [[_COMMUNITY_components deck]]
- 1 edge to [[_COMMUNITY_ui components]]
- 1 edge to [[_COMMUNITY_locale dashboard]]

## Top bridge nodes
- [[PdfViewer.tsx]] - degree 22, connects to 3 communities
- [[rasterize-pdf.ts]] - degree 4, connects to 1 community
- [[rasterizePdfToImages()]] - degree 3, connects to 1 community

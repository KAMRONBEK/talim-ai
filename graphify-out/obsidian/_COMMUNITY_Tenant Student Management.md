...
```dataview
TABLE source_file, type FROM #community/Tenant_Student_Management
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Content Controller (YouTubeOCR)]]
...
## Top bridge nodes
- [[tenant.controller.ts]] - degree 33, connects to 9 communities

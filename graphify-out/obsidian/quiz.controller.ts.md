...
- [[evaluateQuizAnswers()]] - `contains` [EXTRACTED]
- [[evidenceWeightForQuestion()]] - `imports` [EXTRACTED]
- [[formatAttempt()]] - `contains` [EXTRACTED]
- [[formatQuiz()]] - `contains` [EXTRACTED]
- [[getContentMastery()]] - `contains` [EXTRACTED]
- [[getContentMastery()_1]] - `imports` [EXTRACTED]
- [[getLatestAttempt()]] - `contains` [EXTRACTED]
- [[getParam()]] - `imports` [EXTRACTED]
- [[getQuiz()]] - `contains` [EXTRACTED]
...
- [[stripSubmittedOptionLabel()]] - `contains` [EXTRACTED]
- [[submitAnswerValueSchema]] - `imports` [EXTRACTED]
- [[submitQuiz()]] - `contains` [EXTRACTED]
- [[submitSchema]] - `contains` [EXTRACTED]

...
```dataview
TABLE source_file, type FROM #community/Fonts__Layout
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Auth & App Shell UI]]
...
- [[routing.ts]] - degree 8, connects to 1 community
- [[routing]] - degree 5, connects to 1 community
- [[Locale]] - degree 4, connects to 1 community

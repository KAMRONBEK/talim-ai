...
```dataview
TABLE source_file, type FROM #community/src_lib__tutor-scopets
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_src controllers · chat.controller.ts]]
- 3 edges to [[_COMMUNITY_src lib · uzbek-translit.ts]]
...
## Top bridge nodes
- [[tutor-scope.ts]] - degree 23, connects to 5 communities
- [[classifyTutorScope()]] - degree 6, connects to 1 community
- [[guessScopeHeuristically()]] - degree 5, connects to 1 community
- [[ClassifyTutorScopeInput]] - degree 2, connects to 1 community
- [[isTutorScopeRefusal()]] - degree 2, connects to 1 community
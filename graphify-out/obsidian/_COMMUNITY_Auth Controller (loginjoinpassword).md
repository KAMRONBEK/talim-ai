...
# Auth Controller (login/join/password)
...
```dataview
TABLE source_file, type FROM #community/Auth_Controller_login/join/password
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_LearnerSectionUsage Controllers]]
- 4 edges to [[_COMMUNITY_AI Summary Generation]]
- 4 edges to [[_COMMUNITY_API Middleware (authquotarate-limit)]]
...
- 1 edge to [[_COMMUNITY_Tutor-Request & Assessment Controllers]]
...
- [[joinTenantByCode()]] - degree 5, connects to 1 community

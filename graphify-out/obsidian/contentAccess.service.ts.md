...
- [[AuthPayload]] - `imports` [EXTRACTED]
- [[assertCanAccessContent()]] - `contains` [EXTRACTED]
- [[assertCanGenerate()]] - `contains` [EXTRACTED]
- [[assertCanMutateContent()]] - `contains` [EXTRACTED]
- [[assertIndividualContentRoute()]] - `contains` [EXTRACTED]
- [[assertTenantOwnsContent()]] - `contains` [EXTRACTED]
- [[auth.controller.ts]] - `imports_from` [EXTRACTED]
- [[auth.middleware.ts]] - `imports_from` [EXTRACTED]
- [[buildContentListWhere()]] - `contains` [EXTRACTED]

...
- 6 edges to [[_COMMUNITY_QA Traceability Ledger]]
- 2 edges to [[_COMMUNITY_Bug Tracking & Accounts]]
...
- [[QA-Deferred Structural Items (Run 18)]] - degree 7, connects to 1 community
- [[O81 Impersonation token not single-use (replayable stateless JWT)]] - degree 5, connects to 1 community
- [[F63 PDF region-select opened a duplicate Learn panel on desktop]] - degree 2, connects to 1 community